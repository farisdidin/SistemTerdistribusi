...
class Worker(object):
    ...
    def __init__(self):
        self.sharingFolder['folder'] = '/home/didin/Project/SistemTerdistribusi/FP/worker5/' #/home/didin/Project/SistemTerdistribusi/FP/
...
def main():
    ...
    ns = False, host = "127.0.0.1", port = 9004)
